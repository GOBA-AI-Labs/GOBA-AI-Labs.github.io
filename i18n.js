(function () {
  ...
  const translations = {
    en: {
      ...
      'models.desc': 'Drop-in replacements for llama.cpp. Download and run.',
    ...
    ja: {
      ...
      'models.desc': 'llama.cpp\u4E92\u63DB\u3002\u30C0\u30A6\u30F3\u30ED\u30FC\u30C9\u3057\u3066\u3059\u3050\u5B9F\u884C\u3002',
      'model.lossless': '\u30ED\u30B9\u30EC\u30B9',
    ...
    'zh-CN': {
      ...
      'models.desc': 'llama.cpp\u517C\u5BB9\u3002\u4E0B\u8F7D\u5373\u53EF\u8FD0\u884C\u3002',
      'model.lossless': '\u65E0\u635F',
    ...
    'zh-TW': {
      ...
      'hero.stat': 'Qwen3-Coder-Next (80B) \u2014 50% expert pruning, MMLU 72%',
      'models.title': 'PrunedHub \u6A21\u578B',
      'models.desc': 'llama.cpp\u76F8\u5BB9\u3002\u4E0B\u8F09\u5373\u53EF\u904B\u884C\u3002',
      'model.lossless': '\u7121\u640D',
      'model.50pruned': '50% \u524A\u6E1B',
      'model.japanese': '\u65E5\u8A9E',
    ...
    ko: {
      ...
      'models.desc': 'llama.cpp \uD638\uD658. \uB2E4\uC6B4\uB85C\uB4DC\uD558\uACE0 \uBC14\uB85C \uC2E4\uD589.',
      'model.lossless': '\uBB34\uC190\uC2E4',
